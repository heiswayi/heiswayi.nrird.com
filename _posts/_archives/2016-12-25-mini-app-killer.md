...
{% include image.html src="assets/images/z5hJFH8.png" caption="Listing all running applications" %}

{% include image.html src="assets/images/TJG1sV1.png" caption="To kill the selected running application/process" %}

{% include image.html src="assets/images/CxYg1gU.png" caption="Customize filter..." %}

{% include image.html src="assets/images/jHb3HqI.png" caption="List of processes once filtered by the process name" %}
