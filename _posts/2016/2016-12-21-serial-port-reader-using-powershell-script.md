...
description: Initial release of lightweight Serial Port reader written in PowerShell script to read data from a serial port and also export the data into a log file.
